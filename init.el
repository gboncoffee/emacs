...
(use-package color-theme-modern
  ...
  (set-face-foreground 'line-number-current-line "#ffff60")
  (set-face-foreground 'font-lock-keyword-face "#ffff60")
  (set-face-foreground 'font-lock-comment-face "cyan2")
